...
def _test_adding_user(application):
    ...
    with application.app_context():
        ...
        #create a record
        user = User('panchpandu11@gmail.com', 'testtest')
        ...
        user = User.query.filter_by(email='panchpandu11@gmail.com').first()
        log.info(user)
        #asserting that the user retrieved is correct
        assert user.email == 'panchpandu11@gmail.com'
